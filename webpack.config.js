        ...
        plugins: [
            new CopyWebpackPlugin({
                patterns: [
                    ...
                    { from: './src/assets/icons/favicon-16x16.png', to: './' },
                    { from: './src/assets/icons/favicon-32x32.png', to: './' },
                ],
            }),
            ...
            new HtmlWebpackPlugin({
                filename: 'index.html',
                title: 'PWA Started kit with uikit',
            ...
            new FaviconsWebpackPlugin({
                ...
                inject: true,
                favicons: {
                    appName: 'PWA Started Kit',
                    appDescription: 'PWA Started kit with uikit',
            ...
            new WebpackPwaManifest({
                name: 'PWA Started Kit',
                fingerprints: true,
                inject: true,
                short_name: 'pwa-uikit-template',
                description: 'PWA Started kit with uikit',
